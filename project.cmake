...
macro(use_projects THIS_TARGET)
  ...
  foreach(USED_PROJECT ${${THIS_TARGET}_USE_PROJECTS_PROJECTS})
    if(NOT IS_DIRECTORY ${CMAKE_SOURCE_DIR}/${USED_PROJECT})
      message(SEND_ERROR "Attempt to use nonexistent project '${USED_PROJECT}'")
    ...
    if(NOT IS_DIRECTORY ${CMAKE_SOURCE_DIR}/${USED_PROJECT}/public/${USED_PROJECT})
      message(SEND_ERROR "Attempt to use project '${USED_PROJECT}', which doesn't contain a proper public directory ${USED_PROJECT}/public/${USED_PROJECT}")
    ...
    if(NOT EXISTS ${CMAKE_SOURCE_DIR}/${USED_PROJECT}/CMakeLists.txt)
      message(SEND_ERROR "Attempt to use project '${USED_PROJECT}', which doesn't contain a CMakeLists.txt")
